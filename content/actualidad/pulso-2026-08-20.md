...
fecha: 2026-08-20
agente: elena-vega
newsletters: [Bloomberg, Finimize, ING Think, TLDR, Matthew Klein]
---

> [!info] Es una FOTO, no conocimiento permanente
> Caduca. Los cruces con la cartera son lecturas, no órdenes.

(nota hermana: [[pulso-video-2026-08-20]] si Marco la escribió)
...
**Hecho primario (Bloomberg, 20-ago 04:24 UTC):**
...
**Hechos actuales (Bloomberg Authers, 20-ago 04:00 UTC):**
...
2. **Lote 2 diferido (19-ago Lote 2, ~40 newsletters de McKinsey, BLS adicional, Bankinter, FactSet)**: Pendiente para 20-ago (hoy) tarde o 21-ago madrugada. Gap de cobertura de ~4h (volumen 20-ago madrugada bajo, segunda mitad del día probará si hay nuevos catalizadores USA).
...
## Autocheck
- [x] Cifras exactas: Evergrande Hui perpetua (Bloomberg oficial), Bessent $2B→$4B (oficial Tesoro), Unitree +460% (confirmado múltiples fuentes), yield 7-8bps move (Bloomberg), USD/JPY 160 (spot), Gold +6m best day (mercado reporta)
