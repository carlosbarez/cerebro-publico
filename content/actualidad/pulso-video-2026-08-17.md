...
- `📌 predicción:` si las minutas del 19-ago confirman ≥3 disidentes pro-subida, la probabilidad de subida de septiembre supera 50% antes del 31-08 (CME FedWatch).
- `📌 predicción:` si la subasta de 20 años sale débil, el 30 años marca nuevo máximo del ciclo antes del 28-08-2026.
...
- Waymo: 126.000 M$ de valoración, ~4.000 vehículos, 500.000 viajes/semana de pago; >300x EV/ventas. Uber: bookings movilidad +22%, beneficio operativo +28%; invierte 10.000 M$ en AV (equity con hitos + flota de 120.000 vehículos; Stellantis, Lucid, Nuro, Momenta, BYD, Baidu). El autor inició posición pequeña en Uber — conflicto de interés declarado.
- DoD veta vehículos autónomos vinculados a China/Rusia → ni los chinos competirán en EE.UU. ni los americanos en China; la batalla es Europa/Oriente Medio, con el agregador local (Uber) como puerta. Pony AI ya firmó 2.000 robotaxis con Uber en Europa.
- China rentable antes: vehículo a ~30.000 $ (vs 150.000-180.000 $ del Waymo actual), 31% de taxistas >46 años sin reemplazo generacional, decisión gubernamental de sustituir jubilaciones. Apollo Go: 3,2 M viajes Q1 2026 (+120% interanual). Goldman (sic, cifra inicial dudosa): break-even bruto por vehículo en ciudades tier 1 chinas ya en 2026.
- `📌 predicción:` Uber anuncia ≥1 acuerdo AV adicional en Europa u Oriente Medio antes de fin de 2026 (criterio: nota de prensa).
- `📌 predicción:` Pony AI supera los 3.000 robotaxis durante 2026; WeRide cierra 2026 con 2.600 (compañías, vía Goldman).

## Lo que esto le dice al cerebro de Carlos (cruces, no órdenes)

- Semana de catalizadores solapados: datos de China (hoy), minutas FOMC (miércoles), subasta de 20 años, medidas de Bessent contra Irán, CPI de Japón/UK/Canadá, vencimiento masivo de calls (viernes 21).
- Riesgo de anclaje propio: la predicción del Brent >90 está en riesgo material; la evidencia nueva (SPR como amortiguador, demanda china destruida) explica el precio sin necesidad de que el bloqueo sea falso.
- Chipflation y crowding-out del crédito de IA son lo único del día con implicación durable: tensan las tesis de semis y de duración, no solo el corto plazo.
- Protección barata con VIX <15 y skew invertido — dato de régimen, no señal de entrada.

## Preguntas abiertas

- ¿Cuántas semanas de drenaje a 6 M/sem le quedan a la SPR antes de tocar el suelo operativo de 250 M, y qué hace la administración ese día?
- El tránsito real por Ormuz es inmedible con transpondedores apagados: ¿qué proxy fiable queda (seguros, primas de flete, llegadas a China)?
- Si la IA desinfla (BMO) pero la deuda de IA encarece los tipos largos (crowding-out), ¿cuál de los dos efectos llega antes a la cartera?
- ¿El veto del DoD convierte a Uber en la única vía occidental de exposición al robotaxi fuera de EE.UU., o en un intermediario con take rate decreciente?

## Verificación

- Capa gratuita (deepseek-v4-flash) en los 5 destilados: estructura tomada, cifras extremas marcadas (sic) y no ascendidas. Síntesis cruzada vía Kimi; `verifica_cobertura.py`: 3/3 tensiones con respaldo literal en destilados, 0 ignorados.
- Nada asciende a durable en esta nota: 0 verificaciones adversariales requeridas. La alerta sobre `brent-sostiene-90-agosto` se registra aquí y la resuelve el veredicto semanal.
