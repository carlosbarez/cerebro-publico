---
title: "Franklin Resources (BEN) — Análisis Fundamental"
tipo: empresa
...
ticker: BEN
moneda: USD
precio_referencia: 35.35
fecha_precio: 2026-08-27
valor_estimado: 33
gatillo_entrada: <30 USD (margen de seguridad ~10% sobre valor estimado y ~15% bajo precio actual)
veredicto: SEGUIR
revisar_el: 2026-11-24
fuentes: "[\"https://stockanalysis.com/stocks/BEN/\",\"https://stockanalysis.com/stocks/BEN/financials/\",\"https://en.wikipedia.org/wiki/Franklin_Resources\",\"https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=BEN&type=10-K&count=5\",\"https://data.sec.gov/api/xbrl/companyfacts/CIK0000038777.json\",\"https://seekingalpha.com/article/4929408-franklin-resources-stock-higher-inflows-aum-driving-upside-potential\",\"https://www.ft.com/content/425315cf-d360-4898-863a-fb8a4c4fef42\"]"
---
...
| Concepto | FY2025 | FY2024 | FY2023 | FY2022 | FY2021 |
|---|---|---|---|---|---|
| Ingresos | 8.771 | 8.478 | 7.849 | 8.275 | 8.426 |
| Crecimiento ingresos | +3,45% | +8,01% | -5,15% | -1,78% | +51,36% |
| Margen bruto ($) | 3.280 | 3.221 | 3.140 | 3.520 | 3.565 |
| Resultado explotación | 1.170 | 1.234 | 1.500 | 1.954 | 2.095 |
| Margen explotación | 13,3% | 14,6% | 19,1% | 23,6% | 24,8% |
| Beneficio neto | 471,7 | 432,2 | 845,1 | 1.238 | 1.754 |
| BPA | 0,91 | 0,85 | 1,72 | 2,53 | 3,57 |
| FCF | 911,6 | 794,2 | 940,4 | 1.866 | 1.166 |
| Caja + inversiones | 3.088 | 3.310 | 3.686 | 4.135 | 4.358 |
| Deuda total | 3.363 | 3.745 | 3.521 | 3.905 | 3.918 |
| Net cash (deuda) | -274,5 | -435,9 | +165,8 | +230,1 | +440 |
...
## 7. Riesgos (3-6)
1. **Western Asset / riesgo regulatorio:** sonda SEC y DoJ por "cherry-picking" en derivados; riesgo de multas y daño reputacional persistente. >$37B de salidas en un solo trimestre (2024).
2. **Sensibilidad AUM:** los reembolsos netos (especialmente renta fija) comprimen ingresos recurrentes; la fee compression en indexados/ETF presiona márgenes.
3. **Calidad de earnings / ROE deprimido:** ROE ~4% reportado; recuperación incierta y dependiente de normalización de cargos.
4. **Integración M&A:** Putnam y Leg Mason añaden complejidad y riesgo de sinergias no realizadas; deuda y dilución.
5. **Tipos de interés y mercados:** renta fija (~1/3 de AUM) sensible a tipos y a recesión; caídas de mercado reducen AUM y comisiones.
6. **Gobernanza:** control familiar con supervoto limita voz de minoritarios.
...
1. **Acumular solo por debajo de $30** (margen de seguridad ~10% sobre intrínseco y ~15% bajo precio actual).
2. **Vigilar** las salidas de AUM de Western Asset y resolución de la sonda SEC/DoJ; una multa material o más reembolsos ampliarían el descuento.
3. **Confirmar normalización:** BPA ajustado >$2,5 y ROE >8% en próximos 2 trimestres validarían el caso alcista.
4. **No sobreponderar:** riesgo de gobierno familiar y fee compression estructural limitan el techo. Posición de "core value con yield", no de convicción máxima.

<!-- META ticker=BEN veredicto=SEGUIR -->
