...
1. **Red de doble lado por ciudad:** la densidad de conductores reduce tiempos de espera; el moat es local, no global — por eso el 24% de cuota nacional esconde mercados (San Francisco, etc.) donde Lyft es #1.
...
3. **Modelo asset-light:** no es dueña de los vehículos; el capital se va a recompras, no a flotas (Flexdrive es la excepción controlada).
4. **Gobierno saneado:** one-share-one-vote desde 2025-26 (salida de Logan Green y John Zimmer de la junta); consejo 7/8 independiente; recompra de 1.000 M$ (feb-2026). Menos probable que administre la empresa contra el accionista.
...
|---|---|---|---|
| Gross Bookings | 18.507 M$ | 16.099 M$ | +15% |
| Ingresos | 6.316 M$ | 5.786 M$ | +9,2% |
| Ingreso (pérdida) de operación | −188,4 M$ | −118,9 M$ | empeora |
| **Beneficio neto GAAP** | **2.844 M$** | 22,8 M$ | NM |
| Adjusted EBITDA | 528,8 M$ | 382,4 M$ | +38% |
| Margen Adj. EBITDA (% GB) | 2,9% | 2,4% | +50 pb |
| Rides | 945,5 M | 828,3 M | +14% |
| Free cash flow | ~1.116 M$ | ~766 M$ | +46% |
