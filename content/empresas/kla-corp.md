---
title: "KLA Corporation (KLAC) — Estados Unidos, USD"
tipo: empresa
tags: [empresa, equipo-semiconductores, estados-unidos]
fecha: 2026-08-25
agente: carlos-barez
ticker: KLAC
moneda: USD
precio_referencia: 181.57
fecha_precio: 2026-08-24
valor_estimado: 132
gatillo_entrada: 110
veredicto: VIGILAR
revisar_el: 2026-11-23
fuentes: "[\"https://www.prnewswire.com/news-releases/kla-corporation-reports-fiscal-2026-fourth-quarter-and-full-year-results-302836739.html\", \"https://www.sec.gov/Archives/edgar/data/319201/000031920126000027/klac-20260630.htm\", \"https://stockanalysis.com/stocks/KLAC/\", \"https://stockanalysis.com/stocks/KLAC/financials/\", \"https://stockanalysis.com/stocks/KLAC/statistics/\", \"https://stockstory.org/us/stocks/nasdaq/klac\", \"https://www.tradingkey.com/news/market-movers/262128109-market-movers-klac-20260824\", \"https://kalkinemedia.com/us/stocks/technology/kla-corporation-nasdaqklac-chip-innovation-draws-market-attention\", \"https://www.prnewswire.com/news-releases/kla-declares-regular-cash-dividend-302845379.html\", \"https://news.google.com/rss/search?q=KLA+Corporation&hl=en-US&gl=US&ceid=US:en\"]"
---

# KLA Corporation (KLAC) — Estados Unidos, USD

## 1. Negocio

KLA vende las maquinas que **miran los chips mientras se fabrican**: herramientas de inspeccion de defectos y metrologia que recorren el wafer a lo largo de los ~1.000 pasos de una fab. Si un defecto se escapa en la capa 3, el wafer entero acaba en la basura en la capa 40; a precios de wafer puntero (>10.000 $/wafer), inspeccionar es mas barato que tirar. Eso es process control: el seguro de calidad del chip. Modelo de ingreso: venta de sistemas (~77%, producto) + servicio, recambios y software (~23%, $3,13B en FY26, mas recurrente y estable). Clientes: los grandes fabricantes — [[tsmc|TSMC]], Samsung, Intel, [[micron-technology|Micron]], SK Hynix. Ejercicio fiscal julio-junio; FY26 cerro 30-jun-2026 con ingresos $13,58B (+11,7%). Split 10:1 ejecutado el 11-jun-2026; todas las cifras por accion aqui son post-split. Simple de explicar: **cuanto mas complejo el chip, mas inspeccion necesita — y nadie inspecciona como KLA**.

## 2. Industria — [[semiconductores-logica-y-computo-ia]]

Equipo semiconductor = los picos y palas del ciclo de IA ([[asml|ASML]] litografia, [[applied-materials|Applied Materials]] deposicion/grabado, [[lam-research|Lam Research]] grabado profundo, Tokyo Electron, y KLA en control de proceso). Industria oligopolica y ciclica: el capex de fabricacion depende de un puñado de clientes, pero la concentracion post-2010 ha hecho a los supervivientes estructuralmente mas rentables (margenes operativos 30-45% donde antes habia guerras de precios). KPIs que mandan: capex WFE de foundry/memory, contenido de process control por wafer (sube con cada nodo: gate-all-around, apilamiento 3D, HBM, advanced packaging), book-to-bill/RPO y dias de inventario del propio equipo. Metodo de valoracion que DICTA: **multiplos normalizados through-cycle sobre beneficios de mitad de ciclo**, nunca sobre pico — extrapolar un techo de capex IA como si fuera permanente es LA trampa clasica del sector ([[ciclos-de-mercado]]). Nota: la pagina de industria enlazada cubre logica/computo IA; falta puente explicito hacia equipos upstream (pendiente para el orquestador).
...
- ¿Aguanta 10 anos? Si en lo tecnico. ¿Quien lo erosionaria? (a) AMAT/Lam integrando inspeccion in-line en sus propias herramientas de proceso, (b) retadores de e-beam/metrologia ([[nova-ltd|Nova]], Onto) en nichos, (c) que los controles de exportacion cercen el mercado chino donde compite la gama legacy. Ninguna amenaza hoy cerca del nucleo leading-edge.
...
→ **Valor intrinseco ponderado: ~$132** (rango 75-210).
→ Precio actual $181,57 → **margen de seguridad: -27% NEGATIVO**.
...
Primera cobertura de KLA en el Cerebro: no hay tesis ni posicion previa en cartera actual (mapa-tickers sin KLAC). La valoracion a ciegas anterior a leer consenso dio ~$130-135; el consenso de calle dice $232. La diferencia se explica por horizonte: la calle descuenta EPS $5,3-5,4 NTM sin compresion de multiplo; yo aplico probabilidad de ciclo y normalizacion. Nada previo que contradecir — esta ficha funda la postura.
