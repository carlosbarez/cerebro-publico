---
title: "Loews Corporation (L) — Análisis Fundamental"
tipo: empresa
...
ticker: L
moneda: USD
precio_referencia: 109.52
fecha_precio: 2026-08-27
valor_estimado: 135
gatillo_entrada: < 100 USD (≈ valor contable ex-AOCI; acumular hasta 110 USD)
veredicto: COMPRAR
revisar_el: 2026-11-24
fuentes: "[\"https://stockanalysis.com/stocks/L/\", \"https://stockanalysis.com/stocks/L/financials/\", \"https://stockanalysis.com/stocks/L/statistics/\", \"https://en.wikipedia.org/wiki/Loews_Corporation\", \"https://s203.q4cdn.com/873173963/files/doc_financials/2025/ar/v2/2025-Annual-Report.pdf\"]"
---
...
|---|---|---|---|---|---|---|
| Ingresos | 14.657 | 14.044 | 15.901 | 17.510 | 18.454 | 18.694 |
| Crec. ingresos | 16,5% | -4,2% | 13,2% | 10,1% | 5,4% | 3,5% |
| Resultado op. | 2.558 | 1.378 | 2.252 | 2.257 | 2.646 | 2.625 |
| Margen op. | 17,5% | 9,8% | 14,2% | 12,9% | 14,3% | 14,0% |
| Beneficio neto | 1.562 | 822 | 1.434 | 1.414 | 1.667 | 1.687 |
| Margen neto | 10,7% | 5,9% | 9,0% | 8,1% | 9,0% | 9,0% |
| EPS ($) | 6,00 | 3,38 | 6,29 | 6,41 | 7,97 | 8,16 |
| FCF | 2.141 | 2.654 | 3.221 | 2.393 | 2.700 | 1.766 |
...
## 7. Riesgos (3-6)
1. **Descuento de conglomerado persistente**: el mercado puede mantener indefinidamente la penalización a las filiales privadas; el cierre del *discount* no está garantizado.
2. **Riesgo de catástrofe en CNA** (P&C): anos con mayores pérdidas por catástrofes reducen beneficios (ej. 2022). Reservas y litigación en liability profesional.
3. **Tipos de interés y cartera de inversiones**: CNA y el holding tienen carteras de bonos/acciones; caídas de mercado o tipos afectan el resultado de inversiones (en 2025 el ingreso por inversiones del holding cayó $193M→$158M).
4. **Capex e integración hotelera**: Loews Hotels tuvo menor beneficio atribuible (2025: $31M vs $70M) por renovación Miami, impairment Arlington y depreciación de nuevas propiedades de Orlando; el ROI de la expansión puede tardar.
5. **Regulatorio/competencia en pipelines** (FERC) y sensibilidad de la demanda de gas; y cíclico en empaquetado (Altium).
6. **Key-person / gobierno familiar**: continuidad de la disciplina de capital en el relevo generacional Tisch.
...
## 9. Tesis bull / bear
**Bull:** cotiza a ~1,2x valor contable y con descuento a SOTP de ~25–35%; gestión alineada y disciplinada con recompras valor-crecientes; diversificación defensiva (beta 0,52); backlog de Boardwalk y expansión hotelera dan crecimiento; valor contable crece ~9%/año; dividendos crecientes de CNA alimentan el efectivo del holding.
**Bear:** el descuento de conglomerado puede no cerrarse; CNA expuesta a catástrofes y ciclo de inversiones; Hoteles con ROI diferido y depreciación alta; ROIC (7,1%) solo modestamente sobre WACC; la valoración "barata" lleva décadas y el rerating es lento.
...
<!-- META ticker=L veredicto=COMPRAR -->
