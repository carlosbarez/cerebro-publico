---
title: "AMD (AMD) - Ficha de investigacion"
tipo: empresa
...
| Segmento | Ingresos FY2025 (B$) | Ingresos FY2024 (B$) | Op. income FY2025 (B$) | Qué es |
|---|---|---|---|---|
| Data Center | 16,635 | 12,579 | 3,603 | CPUs EPYC + GPUs Instinct (MI300/MI325/MI350) para IA y nube |
| Client and Gaming (Client) | 10,640 | 7,054 | 2,855* | CPUs Ryzen para PC de consumo (*incluye Gaming) |
| Client and Gaming (Gaming) | 3,910 | 2,595 | — | GPUs Radeon + semi-custom (consolas PlayStation/Xbox) |
| Embedded | 3,454 | 3,557 | 1,243 | SoCs adaptativos Xilinx para auto, industrial, coms |
| **Total** | **34,639** | **25,785** | **3,694** | |
